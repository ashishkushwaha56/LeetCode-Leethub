<h2><a href="https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful">2544. Minimum Addition to Make Integer Beautiful</a></h2><h3>Medium</h3><hr><p>You are given two positive integers <code>n</code> and <code>target</code>.</p>
